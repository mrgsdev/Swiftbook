...
class ChatRequestViewController: UIViewController {
    ...
    let denyButton = UIButton(title: "Deny", titleColor: UIColor(hex: 0xD53333), backgroundColor: .mainWhite(), font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
    ...
    private func customizeElements() {
        ...
        denyButton.layer.borderColor = UIColor(hex: 0xD53333).cgColor
